class AlexNet(object): 
    ...
    def create_graph(self): 
        ...
        # 8th Layer: FC and unscaled activations 
    ...
    def conv2d(x, filter_height, filter_width, num_filters, stride_y, stride_x, name, padding='SAME', groups=1): 
        ...
        with tf.variable_scope(name) as scope: 
            weights = tf.get_variable('weights', shape = 
                            [filter_height, 
                             filter_width, input_channels/groups, num_filters])
            ...
            # In the cases of multiple groups, split inputs/weights
                ...
                # Concat the convolved output together 
                conv = tf.concat(axis=3,
        ...
        def fc(x, num_in, num_out, name, relu=True): 
            with tf.variable_scope(name) as scope: 
                ...
                weights = tf.get_variables('weights', shape=[num_in, num_out], trainable=True)
