...
train_file = './data/sets/train.txt'
val_file = './data/sets/validation.txt'
...
with tf.name_scope("train"):
    ...
    print 'Generated training operations.'
...
with tf.name_scope("accuracy"):
    ...
    print 'Generated evaluation operations.'
