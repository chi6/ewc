...
class Trainer(object): 
    ...
    def construct_model(self):
        ...
        if self.retrain:
            ...
            self.model.optimizer(learning_rate=LEARNING_RATE, global_step=self.global_step, train_vars=self.train_vars)
            # mnist = mnist_2
        else:
            self.model.optimizer(learning_rate=LEARNING_RATE, global_step=self.global_step, train_vars=var_list)
